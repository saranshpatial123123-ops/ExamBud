...
const AnimatedList = ({
  ...
  return (
    <div className={`scroll-list-container w-full h-full ${className}`}>
      <div ref={listRef} className={`scroll-list w-full h-full ${!displayScrollbar ? 'no-scrollbar' : ''}`} onScroll={handleScroll}>
